...
int do_bootm (cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
	...
	int		ret;
	boot_os_fn	*boot_fn;
//*********	life 20190903 begin >>> [1/3] support uImaghe 
	int    	iszImage = 0;
//********* life 20190903 end >>> [1/3] support uImaghe   	
...
//*********	life 20190903 begin >>> [2/3] support uImaghe 
		iszImage = 1;     
//*********	life 20190903 end >>> [2/3] support uImaghe 
...
after_header_check:
//*********	life 20190903 begin >>> [3/3] support uImaghe 
...
//*********	life 20190903 end >>> [3/3] support uImaghe 
#endif
